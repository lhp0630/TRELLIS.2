...
if [ "$BASIC" = true ] ; then
    pip install imageio imageio-ffmpeg tqdm easydict "opencv-python-headless>=4.10,<5" ninja trimesh "transformers>=4.56,<5.4" gradio==6.0.1 tensorboard pandas lpips zstandard
